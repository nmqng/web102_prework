...
const unfundedString = totalUnfunded === 1 ?
    `A total of $${totalRaised.toLocaleString()} has been raised for ${numGames} games. Currently, 1 game remains unfunded. We need your help to fund these amazing games!`
    : `A total of $${totalRaised.toLocaleString()} has been raised for ${numGames} games. Currently, ${totalUnfunded} games remain unfunded. We need your help to fund these amazing games!`;
